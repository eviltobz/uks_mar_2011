    ...
    public class UrlBuilderSpecs
    {
        ...
        public class when_constructed : concern
        {
            ...
            It should_store_a_token_representing_the_command_to_run = () =>
                token_store.received(
                    x => x.register(Arg<KeyValuePair<string, object>>.Matches(y => y.Value.Equals(typeof(Blah)))));
        ...
        public class when_rendering_as_a_string : concern
        {
            Establish c = () =>
            {
                ...
                all_tokens =
                    Enumerable.Range(1, 100).Select(x => new KeyValuePair<string, object>(x.ToString(), x)).ToList();
